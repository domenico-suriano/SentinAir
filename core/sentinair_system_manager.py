...
#irca1 has been installed in SentinAir on 2020-05-27_13-11-02
...
#v72m has been installed in SentinAir on 2020-05-20_15-21-33
# do not remove or modify the next three lines below!!!
...
connected_devices = device_scanning(connected_devices,installed_devices,sock,srv,0)
...
while 1:
    ...
    if (command!=__ERROR):
        if command == 's':## scan devices command arrived
            if (rate ==0):
                connected_devices = device_scanning(connected_devices,installed_devices,sock,srv,1)
