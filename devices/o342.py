...
### WARNING: O432_ADDRESS, O432_PORT, O432_ID_STRING and O432_UNITS
### depend on the settings of your Environnement device O432,
###  therefore check on them and update or modify them if necessary.

import socket
import time

O342_ADDRESS = "192.168.20.44"
O342_PORT = 8000
O342_ID_STRING = "O342"
O342_UNITS = "o3[ppb]"
O342_DEVICE_TYPE = "ENVIRONNEMENT-O342"
O342_CONNECTION_TYPE = "eth"
SOCKET_TIMEOUT = 2
MAX_NUM_ATTEMPT = 4
ACK = '\x06'
ERR_VAL = "-100"
...
class O342:
    ...
    def __init__(self):
        self.device_type = O342_DEVICE_TYPE
        self.connection_type = O342_CONNECTION_TYPE
        self.address = O342_ADDRESS
        self.port = O342_PORT
        self.portname = str(O342_PORT)
        self.identity = ""
        self.sensors = O342_UNITS
        self.sk = None
        self.status = 'U'
        self.alarm = None
...
## then returns 1 if the device is found          
    def connect(self):
        try: 
            ...
            return 0        
        command = chr(2) + O342_ID_STRING + "16"
